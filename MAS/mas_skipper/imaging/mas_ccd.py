...
def main():
    ...
    parser.add_argument("--norm-method", choices=["median", "chebyshev", "legendre"], default="median", help="Método de normalización de flats. Def. 'chebyshev'.")
        ...
        for i, f in enumerate(sci_files, 1):
            ...
            if do_cosmic_ray_correction:
                ...
                if not os.path.exists(cosmic_file):
                    # Asegurar que gain_vector sea iterable
